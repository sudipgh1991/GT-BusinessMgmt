...
var Properties = {
    ...
    "azimuth"                       : function (expression) {
        var simple      = "<angle> | leftwards | rightwards | inherit",
            direction   = "left-side | fa-left | left | center-left | center | center-right | right | fa-right | right-side",
            behind      = false,
            valid       = false,
            part;
...
CSSLint.addRule({
    ...
    init: function(parser, reporter){
        ...
        parser.addListener("endrule", function(event){
            ...
            if (!gradients.webkit){
                missing.push("Webkit (Safai 5+, Chrome)");
            }

            if (!gradients.oldWebkit){
                missing.push("Old Webkit (Safai 4+, Chrome)");
            }
