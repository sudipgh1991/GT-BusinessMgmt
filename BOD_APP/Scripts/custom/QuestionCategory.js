...
function QuestionCategoryValidate() {
    $(".error").remove();
    var CategoryName = $("#Name").val();


    if (CategoryName == "") {
        $("#Id").after('<span class="error">Please enter Category Name.</span>');
        return false;
    }
...
function InitUI() {
    ...
    $("#btnSubmit").click(function () {
        ...
        //Validation   
        if (QuestionCategoryValidate() == false) {
            return false;
        }
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data != null && data != undefined && data.IsSuccess == true) {
                ...
                $('.form-control').val('');
                window.location.href = 'QuestionCategoryList';
            }
            else {
