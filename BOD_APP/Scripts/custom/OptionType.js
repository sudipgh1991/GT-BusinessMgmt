...
var formElem = $("#frmOptionTypemaster");
...
function InitUI() {
    function OptionTypeValidate() {
        $(".error").remove();
        var TypeName = $("#Name").val();
        

        if (TypeName == "") {
            $("#Name").after('<span class="error">Please enter  Type Name.</span>');
            return false();
        }
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data != null && data != undefined && data.IsSuccess == true) {
                ...
                $('.form-control').val('');
                window.location.href = 'OptionTypeMasterList';
            }
            else {
...
function retrive(id) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $('#Id').val(data["OTM_Id"]);
            $('#Name').val(data["OTM_Name"]);
            $('#Description').val(data["OTM_Description"]);
        },
        error: function (data) {
