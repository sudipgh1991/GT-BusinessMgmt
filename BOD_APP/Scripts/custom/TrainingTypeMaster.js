...
function ItemMasterValidate() {
    $(".error").remove();
    var TrainingTypeName = $("#Name").val();


    if (TrainingTypeName == "") {
        $("#Name").after('<span class="error">Please enter Training Type Name.</span>');
        return false;
    }
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data != null && data != undefined && data.IsSuccess == true) {
                ...
                $('.form-control').val('');
                window.location.href = 'TrainingTypeMasterList';
            }
            else {
