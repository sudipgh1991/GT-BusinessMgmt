    ...
    key: function () {
        ...
        if (this.type() && this.type().indexOf('key') === 0) {
            ...
            /*
                ...
                Safai key event behavior:
                (Safai sets charCode and keyCode to something crazy for
                special keys.)
                key     event   charCode    keyCode
                DOWN    ku,kd   63233       40
                DOWN    kp      63233       63233
            ...
            */
            ...
            /* look for characters here */
                ...
                /*
                    ...
                    Safai: sets keyCode and charCode to something stupid
                ...
                if (e.which) {
                    ...
                    /*
                        ...
                        Mac browsers and right click:
                            ...
                            - Safai doesn't fire any click events on a right
                              click:
...
/* Safai sets keyCode to these special values onkeypress. */
...
MochiKit.Signal._specialKeys = {
    8: 'KEY_BACKSPACE',
    9: 'KEY_TAB',
    12: 'KEY_NUM_PAD_CLEAR', // weird, for Safai and Mac FF only
    13: 'KEY_ENTER',
    16: 'KEY_SHIFT',
    17: 'KEY_CTRL',
    18: 'KEY_ALT',
    ...
    45: 'KEY_INSERT',
    46: 'KEY_DELETE',
    59: 'KEY_SEMICOLON', // weird, for Safai and IE only
    91: 'KEY_WINDOWS_LEFT', 
