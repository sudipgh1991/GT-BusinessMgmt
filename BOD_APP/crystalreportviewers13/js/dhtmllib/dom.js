...
_webKit=(_userAgent.indexOf("safai")>=0)||(_userAgent.indexOf("applewebkit")>=0)
...
_saf=_moz&&(_userAgent.indexOf("safai")>=0)
...
{
	if (l.addEventListener && !_saf) {// ADAPT00521043 for Safai : Bug 7790: ondblclick doesn't fire when attached with addEventListener	  
...
// it fixes the cases where Safai with doctype fails
...
// Fixes Safai's problem of inserting HTML string before an element
// inserts HTML AFTER the end of a given layer
// e [layer] the layer
// s [String] the HTML
{
