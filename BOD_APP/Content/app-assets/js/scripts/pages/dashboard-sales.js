    ...
    $.ajax({
        ...
        success: function (resp) {
            ...
            $.each(data, function (index, table) {
                dataArray.push(table.MonthWisseIncome);
            });
        ...
        error: function (data) {
            AddErrorAlert("error", "Process Not Sucess...");
        }
    });
    return false;
...
function retriveExpensesGraphPoint() {

    var ctx2 = document.querySelector("#lastYearRevenue").getContext("2d");
    // Expense Chart 
    $.ajax({
        type: "POST",
        url: '/ScriptJson/GetMonthWiseExpensesGraphPoint',
        contentType: "application/json; charset=utf-8",
