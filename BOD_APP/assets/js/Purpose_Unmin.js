...
var Layout = (function () {
    function e(e) {
        $(".sidenav-toggler").addClass("active"),
            ...
            $("body")
                .find(".main-content")
                .append('<div class="sidenav-mask mask-body d-xl-none" data-action="sidenav-unpin" data-target=' + e.data("target") + " />"),
                ...
                case "omnisearch-open":
                    (i = n.data("target")),
                        ...
                        $("body")
                            ...
                            .append('<div class="mask-body mask-body-dark" data-action="omnisearch-close" data-target="' + i + '" />');
                    break;
            ...
            t.on({
                click: function () {
                    !(function (e) {
                        ...
                        e.hasClass("active") ||
                            ($("." + t.attr("class") + " button[data-pricing]").removeClass("active"),
                            e.addClass("active"),
                            a.each(function () {
    ...
    SendEmail = (function () {
        ...
        function t(e, t, a, n, o, i) {
            $.notify(
                { icon: a, title: " Bootstrap Notify", message: "Turning standard Bootstrap alerts into awesome notifications", url: "" },
                {
                    element: "body",
                    type: n,
                    allow_dismiss: !0,
                            ...
                            e.find('button[type="submit"]').text("Sending..."),
                                i.done(function (a, o) {
                                    ...
                                    t(a.notify_title, a.notify_message, a.notify_type),
                                        "success" == i && (e.find(".btn-reset").trigger("click"), grecaptcha.reset()),
                    ...
                    var o = new google.maps.LatLng(e, t),
                        i = {
                            ...
                            styles: [
                                ...
                                { featureType: "water", elementType: "all", stylers: [{ color: a }, { visibility: "on" }] },
                            ],
                        };
...
if ($('[data-toggle="widget-calendar"]')[0]) {
    $('[data-toggle="widget-calendar"]').fullCalendar({
        ...
        editable: !0,
        events: [
            { title: "Call with Dave", start: "2018-11-18", end: "2018-11-18", className: "bg-danger" },
            { title: "Lunch meeting", start: "2018-11-21", end: "2018-11-22", className: "bg-warning" },
            { title: "All day conference", start: "2018-11-29", end: "2018-11-29", className: "bg-success" },
            { title: "Meeting with Mary", start: "2018-12-01", end: "2018-12-01", className: "bg-info" },
            { title: "Winter Hackaton", start: "2018-12-03", end: "2018-12-03", className: "bg-danger" },
            { title: "Digital event", start: "2018-12-07", end: "2018-12-09", className: "bg-warning" },
            { title: "Marketing event", start: "2018-12-10", end: "2018-12-10", className: "bg-primary" },
            { title: "Dinner with Family", start: "2018-12-19", end: "2018-12-19", className: "bg-danger" },
            { title: "Black Friday", start: "2018-12-23", end: "2018-12-23", className: "bg-info" },
            { title: "Cyber Week", start: "2018-12-02", end: "2018-12-02", className: "bg-warning" },
        ],
    });
...
var Dropzones = (function () {
    ...
    Fullcalendar = (function () {
        ...
        a.length &&
            ...
            $("body").on("click", ".new-event--add", function () {
                ...
                "" != t
                    ? (e.fullCalendar("renderEvent", { id: a.Job(), title: t, start: $(".new-event--start").val(), end: $(".new-event--end").val(), allDay: !0, className: $(".event-tag input:checked").val() }, !0),
            ...
            $("body").on("click", "[data-calendar]", function () {
                ...
                "update" === t &&
                    ("" != n
                        ? ((s[0].title = n), (s[0].description = o), (s[0].className = [i]), console.log(i), e.fullCalendar("updateEvent", s[0]), $("#edit-event").modal("hide"))
    ...
    Highlight = (function () {
        $(".highlight").each(function (e, t) {
            !(function (e, t) {
                $(t).before('<button class="action-item btn-clipboard" title="Copy to clipboard"><i class="fa fa-copy mr-2"></i>Copy</button>'),
                    $(".btn-clipboard")
                        .tooltip()
        ...
        e.length &&
            e.each(function () {
                ...
                (e = $(this)),
                    ...
                    (c = { start: [parseInt(r)], connect: [!0, !1], range: { min: [parseInt(n)], max: [parseInt(o)] } }),
            ...
            e.length &&
                e.each(function () {
                    ...
                    (e = $(this)),
                        ...
                        (i = { color: PurposeStyle.colors.theme[o], strokeWidth: 7, trailWidth: 2, text: { value: a, className: n }, svgStyle: { display: "block" }, duration: 1500, easing: "easeInOut" }),
        ...
        e.length &&
            e.each(function () {
                ...
                (e = $(this)),
                    ...
                    (n = new Typed(t, { strings: a, typeSpeed: 100, backSpeed: 70, loop: !0 })),
                    inView(t)
                        .on("enter", function () {
                            n.start();
                        })
                ...
                !(function (e) {
                    var t = {
                        ...
                        xaxis: {
                            ...
                            axisTicks: { show: !0, borderType: "solid", color: PurposeStyle.colors.gray[300], height: 6, offsetX: 0, offsetY: 0 },
                            type: "datetime",
                            categories: ["1/11/2021", "2/11/2021", "3/11/2021", "4/11/2021", "5/11/2021", "6/11/2021", "7/11/2021", "8/11/2021", "9/11/2021", "10/11/2021", "11/11/2021", "12/11/2021", "1/11/2001", "2/11/2001"],
                        },
                        yaxis: {
                            labels: { style: { color: PurposeStyle.colors.gray[600], fontSize: "12px", fontFamily: PurposeStyle.fonts.base } },
                            axisBorder: { show: !1 },
